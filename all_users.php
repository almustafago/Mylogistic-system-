...
if ($ucode == '3' or $code == '3'){
	...
	$selectNew = mysql_query("select * from delevery where (o_state = 'New' and code ='$code' and trackstate ='Unassigened')");
	...
	$selectNew1 = mysql_query("select * from delevery where o_state = 'New' and trackstate !='Unassigened'");
      ...
      <!-- /.search form -->
       ...
       <ul class="sidebar-menu" data-widget="tree">
        ...
        <li  class="treeview">
            ...
            <ul  class="treeview-menu">
              <li class="active"><a href="all_drivers.php">All Drivers</a></li>
		  ...
		  <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <?php if ($group == 1){echo'<li><a href="new_user.php">Add User</a></li>';}?>
            </ul>
          </li>
				  ...
				  <div class="box-body table-responsive">
                   <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tbody>
					  	   <?php 
					 if ($ucode = $code){
					 $selectAll0 = mysql_query("select * from user where u_val = '$ucode' And group_id > '1'");}
					 else{$selectAll0 = mysql_query("select * from user where u_val = '$code'  And group_id > '1'");}
					 
					 
                     if (mysql_num_rows($selectAll0)> 0) {
                      while ($row = mysql_fetch_assoc($selectAll0)) {
						  
						
						echo"<td>" .$row['u_id']."#".$row['u_name']."</td>
						
						<td>".$row['u_name']."</td>
						<td>".$row['u_mobile']."</td>
						<td>".$row['u_pass']."</td>";
						if ($row['group_id'] == 2  ){echo"<td>Supervisor</td>";}elseif($row['group_id'] == 3){Echo"<td>Operator</td>";}else{echo"<td>Financial</td>";}
						if($group == 1){
							
						echo"<td><center><a  class='btn btn-app btn-sm' style ='color:green;font:12px tohoma;' href='ac_user_edit.php?edit=".$row['u_id']."'><i class='fa fa-edit'></i> Edit</a></center></td>
						<td><center ><a  class='btn btn-app btn-sm ' style ='color:red;font:12px tohoma;' href='ac_user_delete.php?edit=".$row['u_id']."'><i class='glyphicon glyphicon-trash'></i>Delete </a></center></td>
