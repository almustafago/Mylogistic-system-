...
mysqli_query( $db,"set names 'utf8'");
	...
	if (isset($_GET['edit'])) {
		...
		$record = mysqli_query($db, "SELECT * FROM user WHERE u_id=$id");
	...
	if (isset($_POST['update'])) {
		...
		mysqli_query($db, "UPDATE user SET  u_name='$dname', u_email='$email', u_pass='$pass',  u_mobile='$phone', group_id = '$ind' 	WHERE  u_id = '$id' ");
		 echo"45";
...
<div class="wrapper">
  ...
  <table width="80%" border="0">
     <tr>
       <td> <label >Driver ID:- </label> </td><td> <?php echo $id; ?><input type="hidden" name="id" value="<?php echo $id; ?>"></td> </tr>
	...
	<tr><td><div class="form-group row">
                            <label class="control-label col-md-3">User Group</label></td><td>
