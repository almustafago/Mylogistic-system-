       ...
       <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="pickedup_orders.php">Picked-up Orders</a></li>
        ...
        <li class="treeview">
		 ...
		 <li class="treeview">
            ...
            <ul class="treeview-menu">
			 <li><a href="all_drivers.php">All Users</a></li>';}
			 if($group == 1){echo'
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Picked-up Orders</li>
        </ol>
      </section>
      ...
      <section class="content container-fluid">
          ...
          <div class="col-xs-12">
              <div class="box">
                  <div class="box-header">
                    <h3 class="box-title">Picked-up Orders</h3>
                  </div>
                  <!-- /.box-header -->
                  <div class="box-body table-responsive">
                    ...
                    if (mysql_num_rows($selectPickup)> 0) {
                      while ($row = mysql_fetch_assoc($selectPickup)) {
						  $send2 = $row ['send_date'];
		...
		$d_id = $row['d_id'];
						...
						if ($state == 0){echo"<td><input name='deleteCb[]' type='checkbox' value=".$row['o_no']." /></td>";}else
							{echo "<td></td>";}
						echo"<td>" .$row['ref']."</td><td>".$row['o_location']."</td>
						<td>".$row["c_phone"]."</td><td>".$row["o_price"]."</td>
						<td>".$row["o_pic"]."</td><td>".$row["weight"]."</td><td>".$row["o_state"]."</td><td>".$row["driver"]."</td>";
						
						if ($state == 0){echo"<td><center><a  class='btn btn-app btn-sm' style ='color:blue;font:12px tohoma;' href='index-pdf-mark.php?print=".$row['o_no']."'><i class='glyphicon glyphicon-print'></i> </a></center></td>
...
echo $dd_res=mysql_query("SELECT u_name, u_id from driver where u_val = '$code'");
        ...
        <?php }
   if ($state == 0){echo"</select>&nbsp;&nbsp;  &nbsp;&nbsp;<input name='delete' value='Send Selected' type='submit'  class='btn btn-primary bg-sm'/>
