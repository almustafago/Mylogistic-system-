...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
       ...
       <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="cancelled_orders.php">Cancelled Orders</a></li>
            </ul>
          </li>
    ...
    <div class="content-wrapper">
          ...
          <div class="col-xs-12">
              <div class="box">
                  <div class="box-header">
                    <h3 class="box-title">Cancell Orders</h3>
                  </div>
                  <!-- /.box-header -->
      ...
      $q="SELECT * FROM  delevery AS d INNER JOIN  comments  AS u ON d.o_no = u.post_id where (trackstate  = 'Failed'  AND comment !=' ' AND code ='$code') group by  o_no";
mysql_query("set character_set_server='utf8'");
        mysql_query("set names 'utf8'");
	$rs = mysql_query($q);	
		...
		$coment = $row['comment'];
						...
						if ($state == 0 and $group <= 3){
						echo"<td><input name='deleteCb[]' type='checkbox' value=".$row['o_no']." /></td>";}
						else{echo"<td></td>";}
						
						echo"<td>" .$row['ref']."#".$row['d_id']."</td><td>".$row['o_location']."</td>
						<td>".$row["c_phone"]."</td><td>".$row["o_price"]."</td>
						<td>".$row["o_price"]."</td><td>".$row["o_price"]."</td><td>".$row["comment"]."</td><td>".$row["driver"]."</td>";
						if ($state == 0 and $group <= 3){
