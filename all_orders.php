    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p><?php  echo $uname;?></p>
          <!-- Status -->
          <a href="#"><i class="fa fa-circle text-success"></i> Online <?php echo $code;?></a>
        </div>
      </div>
...
echo"</table>";
if ($group != 4){
echo"<select class='btn btn-primary bg-green name='ind' ><option value=''> ---Select Driver--- </option>";
...
&nbsp; &nbsp &nbsp; &nbsp &nbsp; &nbsp &nbsp; &nbsp 
					...
					&nbsp; &nbsp &nbsp; &nbsp &nbsp; &nbsp &nbsp; &nbsp 
					<input name='print2' value='Export Selected orders to Excell' type='submit'  class='btn btn-primary bg-red' formaction ='sel_excell.php'/>
