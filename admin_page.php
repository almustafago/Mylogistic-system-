...
if($uname == '' AND $ucode == ''){
	...
	header("Refresh: 0 ; url=admin_log.php");
}
mysql_connect('localhost','root','');
	mysql_select_db('bolog2');
	$selectAll = mysql_query("select * from delevery  ");
	$selectNew = mysql_query("select * from driver ");
	$selectPickup = mysql_query("select * from user group by u_val");
	$selectPickup3 = mysql_query("select * from user ");
	$group = mysql_query("select * from group");
	...
	$selectCancel = mysql_query("select * from delevery where (o_state= 'cancel' or o_state = 'Failed')");
    $selectComplete = mysql_query("select * from delevery where trackstate = 'Completed'");
	$selectNew1 = mysql_query("select * from delevery where o_state = 'New'");
	$selectPickup1 = mysql_query("select * from delevery where o_state = 'pickup' ");
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php  echo mysql_num_rows($selectAll); ?><small></small></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php echo mysql_num_rows($selectPickup3);?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
                ...
                <table class="table no-margin">
                  ...
                  <tbody>
				   ...
				   <?php 
                    ...
                    $selectAl = mysql_query("select driver, count(1) as number,o_state,code, sum(o_price) as coll from delevery    group by o_state, code  order by  code  DESC ");
$i =1;
                    if (mysql_num_rows($selectAl)> 0) {
                      while ($row = mysql_fetch_assoc($selectAl)) {
						...
						<td>".$row['driver']."</td>
						<td><span class='label label-success'>".$row['number']."</span></td>
						<td>".$row['code']."</td>
        ...
        <div class="col-md-4">
          <!-- Info Boxes Style 2 -->
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php echo mysql_num_rows($selectDelevery);?></span>
          ...
          <div class="info-box bg-yellow">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php echo mysql_num_rows($selectPickup1);?></span>
          ...
          <div class="info-box bg-aqua">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php echo mysql_num_rows($selectNew1);?></span>
 ...
 <!-- /.info-box -->
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Recently Users</h3>
            ...
            <div class="box-body">
              <ul class="products-list product-list-in-box">
                  ...
                  mysql_connect('localhost','root','');
	              mysql_select_db('bolog2');
                  $selectPicku = mysql_query("select * from user where u_name != ' ' group by u_val  order by status   DESC LIMIT 35");
				  while($row = mysql_fetch_assoc($selectPicku)) {
					  echo'<li class="item"><div class="product-img">
                    <img src="dist/img/default-50x50.gif" alt="Product Image">
                  </div>
                  <div class="product-info">
                    <a href="users_orders.php?edit='.$row['u_id'].'" class="product-title">'.$row['u_name'].'';
                      if ($row['status'] == '1'){echo'<span class="label label-success pull-right">Active</span></a>';}else{echo '<span class="label label-danger pull-right">No work</span></a>';}
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 <a href="https://www.uttrack.com">Uttrack</a>.</strong> All rights
    reserved.
  </footer>
