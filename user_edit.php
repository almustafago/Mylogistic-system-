...
$db = mysqli_connect('localhost', 'root', '', 'uttrack_db');
mb_language('uni');
...
mysqli_query( $db,"set names 'utf8'");
	...
	if (isset($_POST['update'])) {
		...
		mysqli_query($db, "UPDATE users SET  name='$dname', email='$email', password='$pass',  phone='$phone' 	WHERE  id = '$id' ");
		 echo"45";
		//echo '<meta http-equiv="refresh" content="1;http://www.uttrack.com/AdminL/shuser.php" />';
		//$_SESSION['message'] = "Driver updated!";
		
		header("Refresh: 5 ; url=free_user.php");
       ...
       <!-- Sidebar Menu -->
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="pages/layout/fixed.html"><i class="fa fa-circle-o"></i> Users Group</a></li>
