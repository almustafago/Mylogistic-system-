...
mysql_connect('localhost','root','');
	...
	if ($ucode == '3' or $code == '3'){$selectAll = mysql_query("select * from delevery  where trackstate != 'Unassigened' and code ='$code'");}
...
mysql_connect('localhost','root','');
	...
	if (isset($_GET['edit'])) {
		...
		//echo "<meta http-equiv='refresh' content='0;url=shuser.php'>";
		
		header("Refresh: 5 ; url=mylogo.php");
          ...
          <div class="row">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Delete Progress</h3>
                  </div>
