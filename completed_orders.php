    ...
    <div class="content-wrapper">
      ...
      <section class="content container-fluid">
        <section class="content">
          ...
          <!-- /.col -->
          <div class="col-md-3 col-sm-6 col-xs-12">
              <?php if ($group != 4){echo'<a href="pickedup_orders.php" style="color:darkslategray" >';}?>
            <div class="info-box">
          ...
          <!-- /.col -->
          <div class="col-md-3 col-sm-6 col-xs-12">
              <?php if ($group != 4){echo'<a href="cancelled_orders.php" style="color:darkslategray">';}?>
            <div class="info-box" >
                   ...
                   <div class="box-body table-responsive">
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tr><th>Refrance</th>
						...
						<th><center>Collection Status	</center></th>
						<th><center>Paid Status</center></th>
                    ...
                    if (mysql_num_rows($selectComplete)> 0) {
                      while ($row = mysql_fetch_assoc($selectComplete)) {
						  $send2 = $row ['send_date'];
		$send1 = $row ['complete_date'];
         $send3 = $row['pick_date'];
		...
		$d_id = $row['d_id'];
						...
						<td>".$row["c_phone"]."</td><td>".$row["o_price"]."</td>
						<td>".$row["driver"]."</td><td>".$age."</td>";
						if ($group !=3){if ($row['collection'] == '' and $state == 0){
	echo"
	<td><a style ='color:red;font:12px tohoma;' href='collect.php?collect=".$row['o_no']."'><center><span  class='btn btn-app btn-sm' style ='color:green;font:12px tohoma;'>
	<i class='fa fa-bitcoin' style='font-size:42px;color:red'> 
	</i></span></center></a></td>";
        }else{echo"<td><center><span  class='btn btn-app btn-sm' style ='color:green;font:12px tohoma;'><i class='fa fa-dollar' style='font-size:42px;color:green'></i>
		</span></center></td>";}
						if ($row['paid'] == 'Paid' ){echo "<td><center><span  class='btn btn-app btn-sm' style ='color:green;font:12px tohoma;'><i class='glyphicon glyphicon-ok'></i> ".$row['paid']."</span>
						</center></td>";}else{echo"<td><center><a class='btn btn-app btn-sm' style ='color:green;font:12px tohoma;' href='paid.php?ship=".$row['o_no']."'><i class='fa fa-money' style='font-size:48px;color:red'></i>
		</a></center></td>";}
						echo"<td><span  class='btn btn-app btn-sm' style ='color:green;font:12px tohoma;'><div class='progress progress active'>
                <div class='progress-bar progress-bar-success progress-bar-striped' role='progressbar' aria-valuenow='80' aria-valuemin='0' aria-valuemax='100' style='width: 90%'>
                  <i >100%</i>
                </div>
              </div><span></td>";
