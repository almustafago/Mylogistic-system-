...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
          ...
          <div class="col-xs-12">
              <div class="box">
                  <div class="box-header">
                    <h3 class="box-title"> Order cancelling</h3>
	...
	{
		$id = $_GET['cancel'];
		$sql= mysql_query("UPDATE delevery SET o_state = 'Cancel', trackstate = 'Failed' where  o_no ='$id'");
		if(isset($sql)){
			//echo "<div class ='btn btn-primary btn-lg btn-block'>Order Cancelld</div>";
			//header("Refresh:3; url=vorq.php");
                       	$URL="send_orders.php";
echo '<META HTTP-EQUIV="refresh" content="1 ;URL=' . $URL . '">';
//header("Refresh:1; url=send_orders.php");
		}
	}
