...
$query1 = "SELECT driver, count(1) as number1 FROM delevery  GROUP BY driver";  
              ...
              <div class="box-body table-responsive">
                <table id="example2" class="table table-bordered table-striped">
                 <thead>
                    ...
                    $selectAl = mysql_query("select driver, count(1) as number, sum(o_price) as coll from delevery  where code = '$code' and trackstate = 'Completed' AND driver !=' ' group by driver  order by number  DESC ");
$i =1;
                    if (mysql_num_rows($selectAl)> 0) {
                      while ($row = mysql_fetch_assoc($selectAl)) {
