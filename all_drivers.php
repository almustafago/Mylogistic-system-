...
$selectAll = mysql_query("select * from delevery ORDER BY o_no ASC where code= '$code'");
              ...
              <div class="box">
				  ...
				  <div class="box-body table-responsive">
                   <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tbody>
					  	   <?php 
					  $selectAll0 = mysql_query("select * from driver where u_val = '$code'");
                     if (mysql_num_rows($selectAll0)> 0) {
                      while ($row = mysql_fetch_assoc($selectAll0)) {
						...
						<td>".$row['phone']."</td>
						<td>".$row['u_pass']."</td>
						<td><center><a  class='btn btn-app btn-sm' style ='color:green;font:12px tohoma;' href='driver_edit.php?edit=".$row['u_id']."'><i class='fa fa-edit'></i> Edit</a></center></td>
						<td><center ><a  class='btn btn-app btn-sm ' style ='color:red;font:12px tohoma;' href='driver_delete.php?edit=".$row['u_id']."'><i class='glyphicon glyphicon-trash'></i>Delete </a></center></td>
						</tr>";
                      }
                      }else{echo "no data";}
