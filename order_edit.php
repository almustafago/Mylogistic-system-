...
mysqli_query( $db,"set names 'utf8'");
	...
	if (isset($_GET['edit'])) {
		...
		$record = mysqli_query($db, "SELECT * FROM delevery WHERE o_no=$id");
		...
		if (count($record) == 1 ) {
			...
			$d_price = $n['d_price'];
			$weight = $n['weight'];
			$installation = $n['install_fees'];

			$fast = $n['fastdeliver'];
                        $insfees = $n['pay_method'];
		}
	...
	if (isset($_POST['update'])) {
		...
		mysqli_query($db, "UPDATE delevery SET  city='$phone', o_pic='$o_pic',  c_phone='$c_phone', email='$email', o_price='$price', d_price='$d_price', weight='$weight', install_fees='$installation', fastdeliver='$fast', pay_method ='$insfees'	WHERE o_no=$id");
		 echo"45";
		//echo '<meta http-equiv="refresh" content="1;http://www.uttrack.com/AdminL/vorq.php" />';
...
<div class="wrapper">
  ...
  <table width="80%" border="0">
     <tr>
       <td> <label >Fleet ID:- </label> </td><td> <?php echo $idd; ?><input type="hidden" name="o_no" value="<?php echo $idd; ?>"></td> </tr>
  
	<tr><td><label>Location:-</label> </td><td><?php echo $dname; ?></td> </tr>
	
	<tr><td><label>City:- </label></td><td> <input type="text" name="driverid" value="<?php echo $phone; ?>"size="25"></td> </tr>
	
	<tr><td><label>Number of pice:- </label> </td><td><input type="text" name="model" value="<?php echo $o_pic; ?>"size="25"></td> </tr>
	<tr><td><label>Customer Name:- </label> </td><td><?php echo $c_name; ?></td> </tr>
	<tr><td><label>Customer Phone:- </label> </td><td><input type="text" name="c_phone" value="<?php echo $c_phone; ?>"size="25"></td> </tr>
	<tr><td><label>Email:- </label> </td><td><input type="text" name="email" value="<?php echo $email; ?>" size="25"></td> </tr>
	<tr><td><label>Price:- </label> </td><td><input type="text" name="o_price" value="<?php echo $price; ?>"size="25"></td> </tr>
	<tr><td><label>Delivery Fees:- </label> </td><td><input type="text" name="d_price" value="<?php echo $d_price; ?>"size="25"></td> </tr>
	<tr><td><label>Weight:- </label> </td><td><input type="text" name="weight" value="<?php echo $weight; ?>"size="25"></td> </tr>
	<tr><td><label>Insatllation Fees:- </label> </td><td><input type="text" name="installation" value="<?php echo $installation; ?>"size="25"></td> </tr>
	<tr><td><label>Fast Delivery Fees:- </label> </td><td><input type="text" name="fast" value="<?php echo $fast; ?>"size="25"></td> </tr>
        <tr><td><label>Installation:- </label> </td><td><input type="text" name="insfees" value="<?php echo $insfees; ?>"size="25"></td> </tr>
