                ...
                <form mehtod="post" id="export_excel">  
                     <div class="box-body">
                        <div class="form-group">
                          <p>Here you can upload your orders using Excel file.</p>
                        </div>
                        <div class="form-group">
                            <img src="excel.svg" alt="excel-icon" width="5%" height="5%">
                          </div>
                        <div class="form-group">
                          <label for="exampleInputFile">File input</label>
                          <?php if($lim <= $orders  and $state == '0'){echo'<input type="file" name="excel_file" id="excel_file" class="btn btn-primary bg-green" >';}
						  else {echo '<p class="btn btn-primary bg-red">You dont have limit to upload orders</p>';}
						  ?>
                        </div>
