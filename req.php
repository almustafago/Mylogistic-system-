...
$selectAll0 = mysql_query("select * from rfq_requests");
    ...
    <div class="content-wrapper">
      ...
      <section class="content container-fluid">
		...
		$age2= $diff3->format('%d');
						...
						echo"<td>" .$row['id']."#".$row['email']."</td>
						
						<td>".$row['name']."</td>
						<td>".$row['phone']."</td>
						<td>".$row['email']."</td>
						<td>".$row['company']."</td>
						<td>".$row['drivers_num']."</td>
						<td>".$row['orders_num']."</td>
						";
						
						echo"<td><center><a  class='btn btn-app btn-sm' style ='color:green;font:12px tohoma;' href='user_edit.php?edit=".$row['id']."'><i class='fa fa-edit'></i> Edit</a></center></td>
						<td><center ><a  class='btn btn-app btn-sm ' style ='color:red;font:12px tohoma;' href='delete_user.php?edit=".$row['id']."'><i class='glyphicon glyphicon-trash'></i>Delete </a></center></td>
						</tr>";
