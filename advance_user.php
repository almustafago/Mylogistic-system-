      ...
      <section class="content container-fluid">
              ...
              <div class="box">
				  ...
				  <div class="box-body table-responsive">
                   <table id="example1" class="table table-bordered table-striped">
					  ...
					  $selectAll0 = mysql_query("select * from user where package !='0'");
		...
		$age2= $diff3->format('%d');
						if($age2 == 7){
							...
							$sql= mysql_query("UPDATE user SET status = '0' where created <=  DATE(NOW() - INTERVAL 30 DAY) AND package = '1' ");
						}
						...
						if($row['package'] == '1'){echo "<td>Monthly</td>";}else{echo "<td>Year</td>";}
