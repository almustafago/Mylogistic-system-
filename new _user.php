                     ...
                     <form class="form-horizontal" action="#" method="post">
                      <div class="tile-body">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-8">
                              <input type="submit" name="registerdo" class=" btn btn-primary" value="Add Driver">
                            </div>
                          </div>
                  <!-- /.box-footer-->
                </div>
...
if(isset($_POST['registerdo']))
{
  ...
  else
  {
      ...
      {  
         ...
         $sql1 = mysqli_query($conn, "INSERT INTO user(u_name,  u_pass, u_email, phone, u_val) VALUES ('$u_name1',  '$u_pass', '$u_email', '$phone', '$ucode')");
