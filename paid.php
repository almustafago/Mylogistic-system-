    ...
    <section class="sidebar">
      ...
      <!-- /.search form -->
       ...
       <!-- Sidebar Menu -->
        ...
        <li><a href="send_orders.php"><i class="fa fa-send"></i> <span>Send Orders</span></a></li>
          ...
          <div class="col-xs-12">
              <div class="box">
                  <div class="box-header">
                    <h3 class="box-title"> Pay Shipping Fees</h3>
...
if( isset($_GET['ship']) )
	{
		$id = $_GET['ship'];
		$sql= mysql_query("UPDATE delevery SET  shipping_fees_pay = '1', paid = 'Paid' where  o_no ='$id'");
		if(isset($sql)){
			//echo "<div class ='success'> Order shipping fees paid </div>";
			
		}
	}

header("Refresh:2; url=completed_orders.php");
